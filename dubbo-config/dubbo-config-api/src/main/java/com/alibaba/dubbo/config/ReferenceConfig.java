		...
		if (isJvmRefer) {
            ...
            if (urls.size() == 1) {
                ...
                if (registryURL != null) { // 有 注册中心协议的URL
                    ...
                    //1.将clusterInvoker封装成StaticDirectory
                    //2.再将StaticDirectory封装成AbstractClusterInvoker
                    //3.最终得到一个AbstractClusterInvoker
